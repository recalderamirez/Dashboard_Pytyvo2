...
runtime: shiny
resource_files:
- Departamentos_Paraguay.dbf
- Departamentos_Paraguay.prj
- Departamentos_Paraguay.sbn
- Departamentos_Paraguay.sbx
- Departamentos_Paraguay.shp.xml
- Departamentos_Paraguay.shx
- Distritos_Beneficiarios.cpg
- Distritos_Beneficiarios.dbf
- Distritos_Beneficiarios.prj
- Distritos_Beneficiarios.shx
- Distritos_Paraguay.cpg
- Distritos_Paraguay.dbf
- Distritos_Paraguay.prj
- Distritos_Paraguay.qpj
- Distritos_Paraguay.sbn
- Distritos_Paraguay.sbx
- Distritos_Paraguay.shp.xml
- Distritos_Paraguay.shx
---
...
# save shapefile
writeOGR(merged_dpto_benef, ".", "merged_dpto_benef", 
...
# Merge data with shapefile
merged_dist_benef <- merge(distritos_ben, BENEF_DIST, by = "CLAVE")


# Save as shapefile
writeOGR(merged_dist_benef, ".", "merged_dist_benef", 
         driver = "ESRI Shapefile", layer_options = "ENCODING=UTF-8")
...
# Save as shapefile
writeOGR(merged_dist, ".", "merged_dist", 
         driver = "ESRI Shapefile", layer_options = "ENCODING=UTF-8")
